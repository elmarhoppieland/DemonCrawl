...
func _ready() -> void:
	var icon_scene := load("res://engine/scenes/token_shop/token_shop_category_icon.tscn") as PackedScene
	var category_scene := load("res://engine/scenes/token_shop/token_shop_category_display.tscn") as PackedScene
