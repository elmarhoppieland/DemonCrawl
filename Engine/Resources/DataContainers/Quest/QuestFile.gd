...
@export var token_shop_purchase: TokenShopItem = null  ## The [TokenShopItem] that must be purchased to unlock this quest, or [code]null[/code] if this quest does not need to be purchased.
