...
func load_data(atlas_id: String, path: String, data: Array[Dictionary]) -> void:
	...
	for i in atlas_data.size():
		...
		const ICON_MANAGER_ICON_EDITOR := preload("res://addons/icon_manager/icon_manager_icon_editor.tscn")
...
func _on_collapse_button_pressed() -> void:
	if content_container.visible:
		collapse_button.icon = preload("res://addons/icon_manager/arrow_collapsed.png")
	else:
		collapse_button.icon = preload("res://addons/icon_manager/arrow_open.png")
