...
# ==============================================================================
const USER_FILES_DIR := "res://EffectManager/"
# ==============================================================================
...
func _enter_tree() -> void:
	...
	if not FileAccess.file_exists(USER_FILES_DIR.path_join("EffectSignals.gd")):
...
"
		...
		ResourceSaver.save(effect_signals, USER_FILES_DIR.path_join("EffectSignals.gd"))
